import numpy as np
import math
from utils import get_binary_data, shuffle_data
...
def get_point_wise_prob(gt_labelled_img, clust_labelled_img, train_lp_pixels, cross_pos_pixels):
    ...
    for i in range(n_classes):
        ...
        final_prob[class_pixels] = dist[class_pixels]
...
def get_unlabelled_pixels(exclude_pixels, dist, pos_neg_ratio_in_train, pos_neg_ratio_in_cross, train_lp_pixels, cross_pos_pixels):
...
def get_PU_data(pos_class_list, neg_class_list, data_img, gt_labelled_img, clust_labelled_img, train_pos_percentage, pos_neg_ratio_in_train, cross_pos_percentage, pos_neg_ratio_in_cross):
    ...
    train_unlabelled_indx, cross_unlabelled_indx = get_unlabelled_pixels(exclude_pixels, final_prob, pos_neg_ratio_in_train,
