...
urlpatterns = [
    ...
    # url(r'^get-algo-params$', views.get_algo_params),
    # url(r'^run-algo$', views.run_algo),
    # url(r'^get-algo-names$', views.get_algo_names),
    # url(r'^get-beta$', views.get_beta),
    # url(r'^get-weight$', views.get_weight),
    # url(r'^kill-task$', views.kill_task),
    # url(r'^get-task-status$', views.get_task_status),
    # url(r'^get-initial-centroid$', views.get_initial_centroid),
    # url(r'^pdhg_linear_ui$', views.pdhg_linear_ui),
    # url(r'^initialization$', views.initialization),
    # url(r'^weight_calculation$', views.weight_calculation),
    # url(r'^quad_pdhg_ui$', views.quad_pdhg_ui),
    # url(r'^beta_calculation$', views.beta_calculation),
    # url(r'^fuzzy_c_ui$', views.fuzzy_c_ui),
    # url(r'^image-to-pickle$', views.image_to_pickle),
    # url(r'', views.home)
]
