$('#run_algorithm').on('click', function (e) {
	...
	cache_data.task_id_cache = "beta_calculation_task_id";
	cache_data.pid_cache = "beta_calculation_pid";
	cache_data.output_file_path = "beta_pickle_file_path";
	cache_data.fake_percentage = true;
	start_algorithm("/get-beta",request_data_json,cache_data);
})
