        ...
        for pos_class in include_class_list:
            ...
            if len(neg_class_list) > 0:
                for ratio in Config.type_1_pos_neg_ratio_in_train:
                    ...
                    if not utils.check_if_test_done_models(str(pos_class), test_name, ",".join([str(i) for i in neg_class_list]), Config.data, ratio, False, i):
                        ...
                        = get_train_test_data([pos_class], neg_class_list, data_img, labelled_img, clust_labelled_img, Config.type_1_train_pos_percentage, ratio, Config.type_1_cross_pos_percentage, ratio, True)
