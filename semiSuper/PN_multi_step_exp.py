                    ...
                    for base in Config.baseline_test_list:
                        for temp in Config.temperature_test_list:
                            if not utils.check_if_test_done_models(str(pos_class), test_name, ",".join([str(i) for i in neg_class_list]), Config.data, ratio, False, k, base, temp, Config.spatial_spectral_single_term):
                                ...
                                = get_train_test_data([pos_class], neg_class_list, data_img, labelled_img, clust_labelled_img, Config.type_1_train_pos_percentage, ratio, Config.type_1_cross_pos_percentage, True, base, temp)
                                ...
                                model, train_loss, test_loss = train_PN(train2X, train2Y, testX, testY, train1X, train1Y)
